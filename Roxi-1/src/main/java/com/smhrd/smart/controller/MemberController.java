...
public class MemberController {
   ...
   public ResponseEntity<JSONObject> insertMember(@RequestBody Smart_Member member, RedirectAttributes redirect, Model model) {
   ...
   public String deleteMember(@RequestParam("membernum") int membernum) {
      /*
       * view에서 삭제버튼을 누른 의료진의 번호를 전달받아 jpa를 이용하여 의료진번호가 같은 의료진의 정보를 삭제하는 메소드
       */
